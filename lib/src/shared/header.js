...
class Header extends Component {
  constructor(props) {
        super(props);
        this.state = {userDropDown:false, notifications:{notificationDropDown: false, isNewNotification:true}}
    ...
    if(logged){
      navigation = <div className="navigationPanel">
        <div onClick={this.toggleNotificationDropDown} className="notifications">
          <div className="notificationDropDown" style={{display: (this.state.notifications.notificationDropDown === true ? "inherit" : "none")}}>
